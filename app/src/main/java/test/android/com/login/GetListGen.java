...
/**
 * Clase que se extiende de Action y usa como parametro al servicio que instancia y lista los webApp de generados por equipo.
...
class GetListGen extends Action{
     ...
     * @param s
     */
    public GetListGen(webApp s,TKTobj t) {
        super(s,t);
